  ...
  <div>
    <div class="aaa">
      <van-list
        ...
        class="a-ul"
      >
        <router-link tag="li" v-for="value in list" :key="value.id" :to="{ name: 'goodsDetails', query: { id: value.id } }">
...
"/api/xhr/rcmd/indexV2.json?type=2&size=22&lastItemId=0&categoryId=1005000"      );
